...
s2=input('Посл-сть в строчку:',) #i - стоблбики 
s1=input('Посл-сть в столбик:',) #j - строки

n=int(len(s1)) #кол-во строк -->
k=int(len(s2)) #кол-во столбцов

matrix=[] #создали пустую матрицу для дальнейшей работой с ней
...
#Начинаем идти обратно c конца по матрице - если совпадает, идем по диагонали; нет - идем к наивысшему значению:
